...
export function AreaWizard({ onCreate }: Props) {
  ...
  const [triggerService, setTriggerService] = useState("Gmail");
  const [triggerAction, setTriggerAction] = useState("New email received");
  const [actionParams, setActionParams] = useState("{}");

  const [reactionService, setReactionService] = useState("Gmail");
  const [reactionAction, setReactionAction] = useState("Send email");
